...
# --- [2] CSS: 이름 크기(22px) 및 요일 색상(빨/파) 적용 ---
st.markdown("""
    <style>
    ...
    /* 이름 크기 확대 */
    .card-name { font-size: 22px !important; font-weight: bold; color: #333; border-bottom: 2px solid #eee; }
    .card-value { font-size: 26px !important; font-weight: 900; color: #D32F2F; margin-top: 5px; }
    /* 요일 색상 */
...
if menu == "📍 실시간 상황판":
    ...
    if diff % 3 == 0:
        ...
        # 1시간 단위 근무표
        sched = [
            ("07:00", "08:00", "안내실", "로비", "로비", "휴게"), ("08:00", "10:00", "안내실", "휴게/순찰", "휴게", "로비"),
            ("10:00", "11:00", "휴게", "안내실", "로비", "순찰/휴"), ("11:00", "13:00", "안내/중식", "중식/안내", "로비/중식", "중식/로비"),
            ("13:00", "15:00", "안내/순찰", "휴게/안내", "순찰/로비", "로비/휴게"), ("15:00", "17:00", "안내/휴게", "휴게/안내", "로비/휴게", "휴게/로비"),
            ("17:00", "19:00", "안내실", "휴게/석식", "휴게/로비", "로비/석식"), ("19:00", "21:00", "안내/석식", "안내실", "석식/로비", "로비/휴게"),
            ("21:00", "23:00", "안내/순찰", "순찰/휴게", "로비/순찰", "휴게/로비"), ("23:00", "07:00", "안내/취침", "취침", "취침", "로비/취침")
        ]
