...
# CSS: 상단 여백 1cm(38px) 확보, 타이틀 폰트 축소, 인덱스 제거
st.markdown("""
    <style>
    .block-container { 
    ...
    .main-title {
        font-size: 1.6rem !important; /* 기존 대비 약 30% 축소 */
        font-weight: 800;
        margin-bottom: 20px;
        text-align: center;
        color: #333;
...
# --- [3] 근무 데이터 (30분 단위 디테일 보존 버전) ---
# 이미지의 30분 교대 로직을 한 칸에 "/"로 구분하여 그대로 살렸습니다.
time_data = [
    ["07:00", "08:00", "안내실", "로비", "로비", "휴게"],
    ["08:00", "09:00", "안내실", "휴게", "휴게", "로비"],
    ["09:00", "10:00", "안내실", "순찰", "휴게", "로비"],
    ["10:00", "11:00", "휴게/안내", "안내/휴게", "로비", "순찰/휴게"], # 10:30 교대 구간
    ["11:00", "12:00", "안내실/중식", "중식/안내", "로비/중식", "중식/로비"], # 11:30 교대 구간
    ["12:00", "13:00", "중식/안내실", "안내실/중식", "중식/로비", "로비/중식"], # 12:30 교대 구간
    ["13:00", "14:00", "안내실", "휴게", "휴게/순찰", "로비"], # 13:30 순찰 구간
    ["14:00", "15:00", "순찰", "안내실", "로비", "휴게"],
    ["15:00", "16:00", "안내실", "휴게", "로비", "휴게"],
    ["16:00", "17:00", "휴게/안내", "안내/휴게", "휴게", "로비"], # 16:30 교대 구간
    ...
    ["22:00", "23:00", "순찰", "안내실", "순찰/로비", "로비/휴게"], # 22:30 교대 구간
    ["23:00", "00:00", "안내실", "휴게", "휴게", "로비"],
    ["00:00", "01:00", "안내실", "휴게", "휴게", "로비"],
    ["01:00", "02:00", "안내실/순찰", "휴게/안내", "휴게/로비", "로비/휴게"], # 01:40 로직 근사치
