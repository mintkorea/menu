...
# --- [v1.01] 소스 분리 및 CSS 통일 버전 ---
PATTERN_START = datetime(2026, 3, 9).date()
st.set_page_config(page_title="C조 근무 Workplace v1.01", layout="wide")

# --- [1] CSS: 사용자 원본 스타일 유지 (절대 수정 금지) ---
st.markdown("""
    <style>
...
# 타이틀
st.markdown('<div class="fixed-title">📅 C조 근무 편성표 <small style="font-size:14px; color:gray;">v1.01</small></div>', unsafe_allow_html=True)

# --- [SECTION A] 실시간 상황판 (소스 분리) ---
st.subheader("📍 실시간 근무지 현황")
...
st.markdown("---") # 섹션 구분을 위한 구분선

# --- [SECTION B] 근무표 조회 (소스 분리) ---
st.subheader("🔍 전체 근무 일정 조회")
