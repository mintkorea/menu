...
# --- [2] CSS: 사용자님 소스 그대로 유지 (여백만 최적화) ---
st.markdown("""
    <style>
    /* 타이틀이 잘리지 않도록 상단 여백을 3.5rem으로 고정 */
    .block-container { padding-top: 3.5rem !important; }
    
    /* 사용자님이 주신 타이틀 스타일 그대로 (28px) */
    .fixed-title { 
...
# --- [3] 조회 설정 (사용자님 소스 및 이미지 레이아웃 반영) ---
# 최신 캡처 이미지의 3단 구성을 유지합니다
...
# --- [4] 데이터 및 스타일 로직 (이미지 기반 색상 유지) ---
# 김태언(노랑), 이태원(파랑), 이정석(분홍) 강조
color_map = {
