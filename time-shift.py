...
# --- [3] 근무 데이터 (이미지 100% 대조 교정) ---
# 이미지의 색상 칸(30분 교대)을 정확히 반영했습니다.
time_data = [
    ["07:00", "08:00", "안내실", "로비", "로비", "휴게"],
    ["08:00", "09:00", "안내실", "휴게", "휴게", "로비"],
    ["09:00", "10:00", "안내실", "순찰", "휴게", "로비"],
    ["10:00", "11:00", "휴게/안내", "안내실", "로비", "순찰/휴게"], # 10:30 대원 안내실 고정 반영
    ["11:00", "12:00", "안내실", "중식", "로비", "중식"],
    ["12:00", "13:00", "중식", "안내실", "중식", "로비"],
    ["13:00", "14:00", "안내실", "휴게", "휴게/순찰", "로비"], # 13:30 당직A 순찰 반영
    ["14:00", "15:00", "순찰", "안내실", "로비", "휴게"],
    ["15:00", "16:00", "안내실", "휴게", "로비", "휴게"],
    ["16:00", "17:00", "휴게/안내", "안내실", "휴게", "로비"], # 16:30 대원 안내실 고정 반영
    ...
    ["22:00", "23:00", "순찰", "안내실", "순찰/로비", "로비/휴게"], # 22:30 교대 반영
    ["23:00", "00:00", "안내실", "휴게", "휴게", "로비"],
    ["00:00", "01:00", "안내실", "휴게", "휴게", "로비"],
    ["01:00", "02:00", "안내실", "휴게/안내", "휴게/로비", "로비"], # 01:40 근사치 교정
